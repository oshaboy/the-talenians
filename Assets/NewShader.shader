...
Shader "Myshader" 
{
    Properties 
    {
		[MaterialToggle(_OUTL_ON)] _Outl ("Outline", Float) = 1						//0 // Noam Changed
		[MaterialToggle(_TEX_ON)] _DetailTex ("Enable Detail texture", Float) = 0 	//1
		_MainTex ("Detail", 2D) = "white" {}        								//2
		_ToonShade ("Shade", 2D) = "white" {}  										//3
		[MaterialToggle(_COLOR_ON)] _TintColor ("Enable Color Tint", Float) = 1 	//4 //Noam Changed
		...
		_OutlineColor ("Outline Color", Color) = (0,0,0,1.0)					//10 //Noam Changed
		_Outline ("Outline width", Float) = 2									//11 //Noam Changed
